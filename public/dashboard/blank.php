        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="error404.php" class="nav-item nav-link"><i class="fa fa-search me-2"></i>Consultorio</a>
...
<form class="d-none d-md-flex ms-4">
    <div class="dropdown w-100">
        ...
        <div class="dropdown-menu w-100 bg-white border-0 shadow">
            ...
            <!-- Empieza Página en Blanco -->
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        <h3><i class="fas fa-file-alt"></i> Hola, soy una página en blanco !!!</h3>
                    </div>
                </div>
            </div>
            <!-- Termina Página en Blanco -->
