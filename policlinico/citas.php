...
<head>
    ...
    <title>Agendar Cita - Policlínico Veterinario</title>
...
<body>
    ...
    <section class="appointment section-padding">
        <div class="container">
            ...
            <div class="form-group">
    <label>Seleccione fecha y hora <span class="required">*</span></label>

    <div id="calendar" style="margin-top:10px;"></div>

    <!-- campos ocultos que usará PHP -->
    <input type="hidden" name="fecha" id="fecha" value="<?php echo $datos['fecha']; ?>">
    <input type="hidden" name="hora" id="hora" value="<?php echo $datos['hora']; ?>">
...
</div> <!-- appointment-form-container -->
...
<div class="appointment-info">
    ...
    <div class="info-card">
        ...
        <ul class="info-list">
            ...
            <li><i class="fas fa-info-circle"></i> Si no puede asistir, cancele con 24h de anticipación.</li>
        </ul>
    </div>
    ...
    <div class="info-card">
        ...
        <p class="emergency-contact">
            ...
            <a href="tel:+59847334816">+598 4733 4816</a>
        </p>
    </div>
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dateClick: function(info) {
            ...
            .then(data => {
                ...
                if(data.length === 0){
                    alert("No hay horas disponibles ese día.");
                    return;
                }

                let mensaje = "Horas disponibles:\n\n";
                ...
                if(data.includes(seleccion)){

                    document.getElementById("fecha").value = fecha;
                    document.getElementById("hora").value = seleccion;

                    alert("Cita seleccionada: " + fecha + " a las " + seleccion);
