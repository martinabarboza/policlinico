...
(1, 2, 'Medicina General y Cirugía', 'El Dr. Carlos López es un veterinario con más de 15 años de experiencia en medicina y cirugía de pequeños animales. Se especializa en ortopedia y traumatología veterinaria.', '598-4733-1259', 'assets/dr-lopez.jpg', 'Lunes a Viernes: 9:00 - 17:00', 1),
(2, 3, 'Diagnóstico por Imágenes', 'La Dra. Ana Silva es especialista en diagnóstico por imágenes. Cuenta con formación avanzada en ecografía y radiología veterinaria, con particular interés en cardiopatías de pequeños animales.', '598-4733-1260', 'assets/dra-silva.jpg', 'Martes, Jueves y Viernes: 10:00 - 18:00', 1),
(3, 4, 'Recepción y Atención al Cliente', 'María Rodríguez es la cara visible del Policlínico, encargada de la recepción y coordinación de citas. Su amabilidad y eficiencia son fundamentales para el buen funcionamiento del centro.', '598-4733-1258', 'assets/rodriguez.jpg', 'Lunes a Viernes: 8:00 - 16:00', 1),
(4, 5, 'Asistente Veterinario', 'Pablo González es asistente veterinario con formación en enfermería veterinaria. Apoya a los profesionales en consultas, cirugías y cuidados postoperatorios.', '598-4733-1261', 'assets/gonzalez.jpg', 'Lunes a Viernes: 9:00 - 17:00', 1);
